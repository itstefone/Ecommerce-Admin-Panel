...
@section('styles')
<link rel="stylesheet" type="text/css" href="{{ asset('/backend/js/dropzone/dist/min/dropzone.min.css') }}"/>
@endsection
                      ...
                      <div class="tile-footer">
                          <div class="row d-print-none mt-2">
                              <div class="col-12 text-right">
                                  ...
                                  <a class="btn btn-danger" href="{{ route('admin.product.index') }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Go Back</a>
                              </div>
                          </div>
                      </div>
                  </form>
...
@section('scripts')
<script type="text/javascript" src="{{ asset('/backend/js/dropzone/dist/min/dropzone.min.js') }}" ></script>
